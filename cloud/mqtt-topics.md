...
### 2.5 Data Ingestion Status (publish โดย sensor-streamer-service)
...
| **device-health-service**       | `edge/stat/#`, `edge/tele/.../device/+/health`                 | – *(ประมวลผล/อัปเดต DB)*                                                                    |
