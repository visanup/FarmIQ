 ...
 * 
 * This script runs all data generators in the correct order
 */
...
async function main() {
  console.log('🎯 Starting All Data Generators...');
  console.log('📋 This will run all data generators in sequence');
  ...
  const scripts = [
    ...
    { file: 'generate-sensor-readings.js', description: 'Generating sensor readings data' },
  ...
  for (const script of scripts) {
    ...
    console.log('⏳ Waiting 10 seconds before next script...');
