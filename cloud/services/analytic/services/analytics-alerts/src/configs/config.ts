...
const envSchema = z.object({
  ...
  KAFKA_CLIENT_ID: z.string().default('analytics-alerts'),
  CONSUMER_GROUP: z.string().default('analytics-alerts-group'),
  ...
  // Kafka Topics
  TOPIC_ANALYTICS_FEATURES: z.string().default('analytics.features'),
  TOPIC_ANALYTICS_PREDICTIONS: z.string().default('analytics.prediction.v1'),
  TOPIC_ANALYTICS_ANOMALIES: z.string().default('analytics.anomaly.v1'),
  TOPIC_ANALYTICS_DLQ: z.string().default('analytics.invalid-readings'),
});
...
export const {
  ...
  ALERT_BACKEND,
  ENV,
  TOPIC_ANALYTICS_FEATURES,
  TOPIC_ANALYTICS_PREDICTIONS,
  TOPIC_ANALYTICS_ANOMALIES,
  TOPIC_ANALYTICS_DLQ,
} = envResult.data;
